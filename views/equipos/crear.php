            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg">
                    <div class="card-header bg-transparent border-bottom border-secondary py-3">
                        <h4 class="mb-0 fw-bold fst-italic">AÑADIR <span style="color: var(--liga-cyan)">CLUB</span></h4>
                    </div>
                    <div class="card-body p-4">
                        <form id="formEquipo" method="POST" action="index.php?controller=equipo&action=create">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control form-control-lg" placeholder="Ej: Real Zaragoza" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="ciudad" id="ciudad" class="form-control" placeholder="Ej: Zaragoza" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label class="form-label text-secondary text-uppercase small fw-bold">Aforo Estadio</label>
                                    <input type="number" name="capacidad_estadio" id="capacidad_estadio" class="form-control" placeholder="Ej: 33000" required>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <button type="submit" class="btn btn-cyan btn-lg text-uppercase">Guardar Registro</button>
